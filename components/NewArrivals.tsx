...
export default function ExpandingArrivals() {
  return (
    <section className="w-full bg-[#FFF6F7] py-6 select-none">
      <div className="w-full max-w-[1320px] mx-auto px-4 md:px-8">
        <div className="w-full flex flex-col lg:flex-row lg:h-[320px] h-auto rounded-none bg-white border-4 border-white shadow-sm select-none overflow-hidden">
          ...
          <div className="flex-1 flex w-full h-[320px] lg:h-full overflow-hidden rounded-none">
