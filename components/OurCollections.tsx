...
export function OurCollections() {
  return (
    <section className="w-full bg-[#FFF6F7] pt-4 pb-6 px-4 md:px-8 relative select-none">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-6 max-w-[1400px] mx-auto px-2">
